...
const fragmentShader = `
  ...
  void main() {
    ...
    // Più lontano dal mouse, più intenso è il blur
    float blurIntensity = mix(amount, maxBlurAmount, smoothstep(0.0, lightRadius, distToMouse));
    
    // Applica il blur orizzontale se il layer è attivo
    if (blurLayer) {
